      ...
      const intersectionCallback = function (entries, observer) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const delayMs = parseFloat(delay) * (delay < 10 ? 1000 : 1);
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Swim-By uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6c2d6ef0-5509-44b9-afb7-56d4ec0d98e9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6c2d6ef0-5509-44b9-afb7-56d4ec0d98e9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6c2d6ef0-5509-44b9-afb7-56d4ec0d98e9';
